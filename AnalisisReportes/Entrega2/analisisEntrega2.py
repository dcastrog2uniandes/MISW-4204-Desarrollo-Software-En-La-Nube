...
f = open("logArchivosEntrega2.txt", "r").read()
datos = f.split('\n')
print(len(datos))
...
print('Se tiene un tiempo medio de procesamiento de {:.1f}s, con desviación de {:.1f}s. Esto equivale a {:.1f} archivos por minuto'.format(df.tProceso.mean(), 60/df.tProceso.mean()))
